<x-guest-layout>
    <div class="text-center container">
        <div class="card mx-auto mt-5 bg-secondary" style="width: 40rem; ">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('driverstore') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Vehicle Plate Number" name="vehicle_platenumber" :value="old('vehicle_platenumber')">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Vehicle Type" name="vehicle_type" :value="old('vehicle_type')">
                        @error('vehicle_type')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
